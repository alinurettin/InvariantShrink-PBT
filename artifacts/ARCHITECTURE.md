# 📐 System Architecture: InvariantShrink-PBT
...
```mermaid
flowchart TD
    CLI["💻 CLI Interface (src/cli.js)"] --> Engine["🧠 InvariantShrink-PBT Algorithmic Engine (src/pbt_engine.js)"]
...
1. **Algorithmic Engine (`src/pbt_engine.js`):** Core logic implementing Property-Based Testing & Automated Shrinking. Zero third-party runtime bloat.
2. **REST API & Web Server (`src/index.js`):** Lightweight HTTP microservice running on port 7073 providing health probes and interactive endpoints.
